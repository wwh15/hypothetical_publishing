...
export const salesTablePresets = {
  ...
  full: {
    columnIds: ['id', 'title', 'author', 'quantity', 'publisherRevenue', 'authorRoyalty', 'date', 'paid'] as SalesColumnId[],
  ...
  bookDetail: {
    columnIds: ['id', 'quantity', 'publisherRevenue', 'authorRoyalty', 'date', 'paid'] as SalesColumnId[],
    defaultSortField: 'date' as const,
    defaultSortDirection: 'desc' as const,
    showDateFilter: true,
  },
  ...
  minimal: {
    columnIds: ['quantity', 'publisherRevenue', 'authorRoyalty', 'date', 'paid'] as SalesColumnId[],
    defaultSortField: 'date' as const,
    defaultSortDirection: 'desc' as const,
 ...
 */
export function getPresetColumns(preset: keyof typeof salesTablePresets): ColumnDef<SaleListItem>[] {
 ...
 */
export function getColumnsByVisibleIds(visibleIds: SalesColumnId[]): ColumnDef<SaleListItem>[] {
