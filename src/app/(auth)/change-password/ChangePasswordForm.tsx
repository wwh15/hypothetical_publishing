...
export default function ChangePasswordForm({ companyName, tagline, logoUrl }: ChangePasswordFormProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900">
      <AuthLogo companyName={companyName} tagline={tagline} logoUrl={logoUrl} />
