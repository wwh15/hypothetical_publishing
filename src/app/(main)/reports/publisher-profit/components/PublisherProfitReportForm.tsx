...
interface PublisherProfitReportFormProps {
...
export function PublisherProfitReportForm({
  initialStartQuarter,
  initialStartYear,
  initialEndQuarter,
  initialEndYear,
}: PublisherProfitReportFormProps) {
  ...
  function handleGenerate() {
    ...
    window.open(
      `/api/reports/publisher-profit?${params.toString()}`,
      "_blank",
      "noopener,noreferrer"
    );
  }
    ...
    <div className="space-y-6 max-w-xl">
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
          <Label htmlFor="pp-start-quarter">Start</Label>
        ...
        <div className="space-y-2">
          <Label htmlFor="pp-end-quarter">End</Label>
          <div className="flex gap-2">
            <select
              id="pp-end-quarter"
              value={endQuarter}
